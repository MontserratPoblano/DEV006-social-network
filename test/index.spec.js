...
// import forgotPassword from '../src/views/forgotPassword.js';
import { registerWithGoogle } from '../src/lib/index.js';

describe('myFunction', () => {
  // eslint-disable-next-line jest/no-focused-tests
  it.only('consigue visualizar home', () => {
...
describe('probando alert de bienvenida con registro por google', () => {
  ...
  // eslint-disable-next-line jest/no-focused-tests
  it.only('debería mostrar un alert de fallo al usuario', () => {
    const google = document.getElementById('btnGoogle');
    registerWithGoogle.mockRejectedValue({
      name: 'Error',
      message: 'Failed register, try again',
    });
    google.click();
    setTimeout(() => {
